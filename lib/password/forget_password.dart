...
import 'package:managers_view/password/reset_password.dart';
            ...
            onPressed: () async {
              if (_formKey.currentState.validate()) {
                ...
                if (!NetworkData.connected) {
                  ...
                  var rsp = await checkManagerusername(username);
                  if (rsp == null) {
                    print('NOT FOUND!');
                    ...
                    print(gstr);
                    var resp = await addSmsCode(username, gstr, mobile);
          ...
          onTap: () async {
            if (_formKey.currentState.validate()) {
              if (!NetworkData.connected) {
                ...
                var scode = await checkSmsCode(
                    GlobalVariables.fpassUsername, smscodeController.text);
                if (scode == null) {
                  Navigator.pop(context);
                  print('NOT FOUND!');
                  showGlobalSnackbar('Information', 'Invalid Code. Try again.',
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    if (!NetworkData.connected) {
                      ...
                      var gstr = generateString();
                      print(gstr);
                      var resp = await addSmsCode(GlobalVariables.fpassUsername,
                          gstr, GlobalVariables.fpassmobile);
                      if (resp != null) {
                        Navigator.pop(context);
                      }
                    }
