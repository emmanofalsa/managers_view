...
import 'package:managers_view/today/cheque.dart';
...
class _OrdersAndTrackingState extends State<OrdersAndTracking> {
  ...
  loadOrders() async {
    var getO = await getOrders(OrderData.trans);
    if (!mounted) return;
    setState(() {
      _list.clear();
      _list = getO;
  ...
  getChequeData() async {
    ...
    var getC = await getCheque(OrderData.trans);
    if (!mounted) return;
    setState(() {
      _chequelist = getC;
      // print(_chequelist);
  ...
  loadRemovedOrders() async {
    int z = 1;
    _sampList.clear();
    var smp = await getRemovedOrders(OrderData.trans);
    _sampList = smp;
    // print(_sampList);
    ...
    _unservedList.clear();
    var getU = await getUnservedOrders(OrderData.trans);
    // _unservedList = getU;
    _unservedList = getU;
    if (!mounted) return;
    setState(() {
      if (_unservedList.isNotEmpty && _returnedList.isEmpty) {
        ...
        _unservedList.forEach((element) async {
          ...
          // itemNo = _unservedList.length.toString();
    ...
    _returnedList.clear();
    var getR = await getReturnedOrders(OrderData.trans);
    // _returnedList = getR;
  ...
  getTotal() {
    ...
    _list.forEach((element) {
      ...
      itemNo = (int.parse(itemNo) + int.parse(element['req_qty'])).toString();
    });
    OrderData.totamt = orderTotal;
    OrderData.grandTotal = orderTotal;
  }
  ...
  loadDeliveredOrders() async {
    ...
    var getO = await getDeliveredOrders(OrderData.trans);
    if (!mounted) return;
    setState(() {
      // _templist = getO;
      _templist.clear();
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (_unservedList[index]['item_path'] == '') {
                        noImage = true;
                      } else {
                        noImage = false;
                      }
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (_returnedList[index]['item_path'] == '') {
                        noImage = true;
                      } else {
                        noImage = false;
                      }
                          ...
                          children: <Widget>[
                            ...
                            Container(
                                ...
                                child: noImage
                                    ...
                                    : Image.network(UrlAddress.itemImg +
